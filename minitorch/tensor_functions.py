...
class Neg(Function):
    ...
    def forward(ctx: Context, t1: Tensor) -> Tensor:
        """Elementwise negation forward."""
        return t1.f.neg_map(t1)

    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        """Elementwise negation backward."""
...
class Inv(Function):
    @staticmethod
    def forward(ctx: Context, t1: Tensor) -> Tensor:
        """Elementwise inverse forward."""
        ctx.save_for_backward(t1)
        return t1.f.inv_map(t1)

    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        """Elementwise inverse backward."""
        (t1,) = ctx.saved_values
...
class Log(Function):
    @staticmethod
    def forward(ctx: Context, t1: Tensor) -> Tensor:
        """Elementwise log forward."""
        ctx.save_for_backward(t1)
        return t1.f.log_map(t1)

    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        """Elementwise log backward."""
        (t1,) = ctx.saved_values
...
class LT(Function):
    @staticmethod
    def forward(ctx: Context, t1: Tensor, t2: Tensor) -> Tensor:
        """Elementwise less than forward."""
        return t1.f.lt_zip(t1, t2)

    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, Tensor]:
        """Elementwise less than backward."""
...
class EQ(Function):
    @staticmethod
    def forward(ctx: Context, t1: Tensor, t2: Tensor) -> Tensor:
        """Elementwise equal forward."""
        return t1.f.eq_zip(t1, t2)

    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, Tensor]:
        """Elementwise equal backward."""
        return grad_output.zeros(), grad_output.zeros()
...
class IsClose(Function):
    @staticmethod
    def forward(ctx: Context, t1: Tensor, t2: Tensor) -> Tensor:
        """Elementwise close check forward."""
        return t1.f.is_close_zip(t1, t2)

    @staticmethod
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, Tensor]:
        """Elementwise close check backward."""
        return grad_output.zeros(), grad_output.zeros()
...
class Permute(Function):
    ...
    def forward(ctx: Context, t1: Tensor, order: Tensor) -> Tensor:
        ...
        order_tuple = [int(order[i]) for i in range(order.size)]
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, float]:
        ...
        for permuted_dim, original_dim in enumerate(order):
            inv_order[original_dim] = permuted_dim
...
def grad_central_difference(
    ...
    """Compute the gradient using central difference for testing purposes."""
    x = vals[arg]
    up = zeros(x.shape)
    up[ind] = epsilon
